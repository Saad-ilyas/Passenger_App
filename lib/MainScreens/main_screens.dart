...
import 'package:passenger_app/MainScreens/rate_driver_screen.dart';
import 'package:passenger_app/MainScreens/search_places_screen.dart';
import 'package:passenger_app/MainScreens/select_nearest_active_driver_screen.dart';
import 'package:passenger_app/assistants/assistants_methods.dart';
import 'package:passenger_app/global/global.dart';
import 'package:passenger_app/infohandler/app_info.dart';
import 'package:passenger_app/main.dart';
import 'package:passenger_app/widgets/drawer.dart';
...
import 'google_map_screen_for_carpool.dart';
...
AssistantMethods.readTripsKeysForOnlineUser(context);
  ...
  searchNearestOnlineDrivers() async
  {
   ...
   var response = await Navigator.push(context, MaterialPageRoute(builder: (c)=> SelectNearestActiveDriversScreen(refrenceRideRequest:referenceRideRequest)));
...
if(snap.snapshot.value != null)
  {
    ...
    FirebaseDatabase.instance.ref().child("Driver").child(ChosenDriverId!).child("newRideStatus").onValue.listen((eventSnapshot)
    {
      // driver cancels rideRequest
      if(eventSnapshot.snapshot.value == "idle")
        {
          Fluttertoast.showToast(msg: "Driver has cancelled the ride request. Please choose another driver");
...
setState(() {
  ...
  showWaitingResponseFromDriverUI()
  {
    setState(() {
      searchLocationContainerHeight =0;
      waitingResponseFromDriverContainerHeight =280;
...
Positioned(
  ...
  top: 90,
    left:30 ,
      ...
      ElevatedButton(
        ...
        onPressed: ()
        {
          Navigator.push(context,MaterialPageRoute(builder: (c)=> showlocation()));
        },
  ...
  {
    // restart-refresh-minimize app automatically
    SystemNavigator.pop();
  }
              },
              child: CircleAvatar(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          const Icon(Icons.add_location_alt_outlined, color: Colors.deepOrangeAccent,),
